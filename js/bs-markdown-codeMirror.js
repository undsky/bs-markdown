(function($) {
	...
	$.fn.bsmd = function(options) {
		...
		var source = $('<div id="' + id + '" class="bsmd" style="width:100%;height:100%;position:relative;"><div class="btn-toolbar" role="toolbar"></div><div class="bsmd-editor" style="position:absolute;top:40px;bottom:0;left:0;right:0;"></div><div class="bsmd-preview" style="position:absolute;top:40px;bottom:0;left:0;right:0;display:none;"></div></div>');
